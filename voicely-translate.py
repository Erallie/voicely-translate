    ...
    async def _transcribe(
        ...
        response = await openai_client.audio.transcriptions.create(
            ...
            prompt=(
                ...
                "Preserve usernames, personal names, character names, place names, organization names, "
                "brand names, product names, titles, honorifics, and other proper nouns as spoken. "
                "Do not translate, localize, substitute, or normalize a name, username, title, or other proper noun "
                "into a different word merely because another interpretation would be more common in the detected language. "
                "Usernames and names may contain unusual spellings, capitalization, numbers, abbreviations, "
                "foreign-language words, or combinations of words; preserve them as accurately as the audio allows. "
                "When a name, username, or title is clearly being spoken, prefer preserving its apparent proper-noun form "
